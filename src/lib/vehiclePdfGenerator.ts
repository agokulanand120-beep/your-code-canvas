...
export const generateVehicleBrochurePDF = async (
  ...
  doc.text(dealer.dealer_name || 'UpcurvHub', 15, 12);
  ...
  doc.setFontSize(9);
  doc.setFont('helvetica', 'bold');
  doc.text(dealer.dealer_name || 'UpcurvHub', W / 2, footerY + 7, { align: 'center' });

  doc.setFontSize(6.5);
  doc.setFont('helvetica', 'normal');
  doc.setTextColor(180, 190, 200);
  doc.text('Contact us for test drive & best deals  •  Generated by UpcurvHub', W / 2, footerY + 13, { align: 'center' });
