...
const Auth = () => {
  ...
  // Auto-enter: if a saved session already exists (e.g. installed PWA reopened),
  // send the dealer straight into the app instead of showing the login form.
  useEffect(() => {
    let active = true;
    supabase.auth.getSession().then(async ({ data: { session } }) => {
      ...
      const { data: adminRow } = await supabase
        ...
        .maybeSingle();
      navigate(adminRow ? "/admin/marketplace" : "/dashboard", { replace: true });
    });
    return () => {
      active = false;
    };
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[70%] items-center justify-center relative overflow-hidden bg-sky-200">
        ...
        <div className="relative z-10 text-center text-white max-w-2xl px-12">
          ...
          <h1 className="text-6xl font-bold mb-6">UpcurvHub</h1>
