  ...
  const faqCategories = [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "Yes, all dealers on UpcurvHub go through a strict verification process. We verify their business documents, showroom, and track record before approving them on our platform."
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          question: "How do payments work on UpcurvHub?",
          answer: "UpcurvHub is a vehicle discovery and marketplace platform that connects buyers with verified dealers. All payment transactions, pricing negotiations, EMI arrangements, and financial terms are handled directly between the buyer and the respective dealer. UpcurvHub does not process or facilitate any payments."
        },
        {
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-slate-600 mb-8">
            Find answers to common questions about buying, selling, and using UpcurvHub.
          </p>
