      ...
      try {
        await supabase.functions.invoke("send-email", {
          body: {
            ...
            subject: `[UpcurvHub ${activeTab === "report" ? "Issue Report" : "Contact"}] ${form.subject || "General"} - ${form.name}`,
            html: `
              <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8fafc; border-radius: 16px; overflow: hidden;">
                <div style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%); padding: 32px 24px; text-align: center;">
                  <h1 style="color: #ffffff; margin: 0; font-size: 22px; font-weight: 700;">🚗 UpcurvHub</h1>
            ...
            <Card className="border-0 shadow-sm rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+916380715292" className="text-slate-600 hover:text-blue-600">+91 63807 15292</a>
            ...
            <Card className="border-0 shadow-sm rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/918807858256" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-emerald-600">+91 88078 58256</a>
            ...
            <Card className="border-0 shadow-sm rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:upcurvinnovations@gmail.com" className="text-slate-600 hover:text-purple-600 break-all">upcurvinnovations@gmail.com</a>
            ...
            <Card className="border-0 shadow-sm rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Coimbatore, Tamil Nadu</p>
