            ...
            <CardContent className="p-6 md:p-10 prose prose-slate max-w-none">
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  By accessing and using UpcurvHub ("Platform"), you accept and agree to be bound by the terms and provisions 
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  UpcurvHub is an online marketplace that connects verified vehicle dealers with buyers. Our services include:
                </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  UpcurvHub is a marketplace platform and does not own or sell vehicles. We are not responsible for:
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  All content on UpcurvHub, including logos, text, graphics, and software, is our property and protected 
              ...
              <section>
                ...
                <p className="text-slate-600 leading-relaxed">
                  ...
                  <a href="mailto:legal@upcurvhub.com" className="text-blue-600 hover:underline">legal@upcurvhub.com</a>
                </p>
              </section>
            </CardContent>
          </Card>
