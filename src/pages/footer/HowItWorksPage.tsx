    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">How UpcurvHub Works</h1>
          <p className="text-lg text-slate-600">
            Whether you're buying your dream vehicle or selling your inventory, UpcurvHub makes it simple, secure, and seamless.
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-slate-500 text-center mb-10">Grow your business with UpcurvHub</p>
        ...
        <Card className="border-0 shadow-lg rounded-3xl bg-gradient-to-br from-blue-50 to-blue-100 p-8 md:p-12 mb-16">
          <h2 className="text-2xl font-bold text-slate-900 text-center mb-8">Why Choose UpcurvHub?</h2>
