...
import { extractDistrict, extractState, districtsFromAddresses } from "@/lib/location";
import { dealerPath } from "@/lib/seoSlug";
...
const AllDealers = () => {
  ...
  const getDealerLocation = (address: string) => ({
    city: extractDistrict(address) || "Unknown",
