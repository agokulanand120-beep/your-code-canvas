...
BEGIN
  ...
  FOR i IN 1..200 LOOP
    ...
    INSERT INTO vehicles (
      user_id, code, brand, model, variant, color, fuel_type, transmission,
  ...
  FOR i IN 1..200 LOOP
    INSERT INTO leads (
      user_id, lead_number, customer_name, phone, email, city, vehicle_interest,
      budget_min, budget_max, source, status, priority, lead_type, follow_up_date
    ) VALUES (
      p_user_id, 'LED-'||v_tag||'-'||lpad(i::text,4,'0'),
  ...
  FOR i IN 1..200 LOOP
    INSERT INTO vehicle_purchases (
      user_id, purchase_number, vehicle_id, vendor_id, purchase_price, amount_paid,
      balance_amount, payment_mode, purchase_date, notes
    ) VALUES (
      p_user_id, 'PUR-'||v_tag||'-'||lpad(i::text,4,'0'),
  ...
  FOR i IN 1..200 LOOP
    ...
    INSERT INTO payments (
      user_id, payment_number, amount, payment_type, payment_mode, payment_date,
      payment_purpose, description, reference_id, reference_type, customer_id
    ) VALUES (
      p_user_id, 'PAY-'||v_tag||'-'||lpad(i::text,4,'0'),
  ...
  FOR i IN 1..200 LOOP
    INSERT INTO expenses (
      user_id, expense_number, description, category, amount, expense_date, payment_mode, notes
    ) VALUES (
      p_user_id, 'EXP-'||v_tag||'-'||lpad(i::text,4,'0'),
